...
from cogniq_server.api.schemas import AgentRunResponse, PipelineDetailResponse, PipelineResponse
...
from cogniq_shared.domain.enums import Stage
    ...
    try:
        ...
        match status:
            ...
            case "in_analysis":
                ...
                from cogniq_server.dependencies import get_task_queue
