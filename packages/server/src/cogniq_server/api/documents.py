...
from cogniq_server.api.schemas import CreateDocumentRequest, DocumentResponse, UpdateDocumentRequest
from cogniq_server.auth.dependencies import get_current_user
from cogniq_server.auth.models import User
from cogniq_server.dependencies import get_db, verify_team_member
from cogniq_shared.domain.issue import Document
